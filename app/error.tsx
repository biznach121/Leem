  ...
  return (
    <section className="spabox-page">
      <div className="spabox-shell max-w-[760px] text-center">
        ...
        {error.digest && (
          <p className="mt-6 text-xs font-mono text-[#004745]/60">
            Reference: <code className="text-[#003a37]">{error.digest}</code>
          </p>
        )}
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          ...
          <Link
            href="/"
            className="inline-flex min-h-14 items-center justify-center border border-[#003a37]/18 px-7 text-sm font-semibold text-[#003a37] transition-colors hover:bg-[#bfd7eb]"
          >
            Back home
          </Link>
        </div>
