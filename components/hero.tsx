...
export function Hero({
  ...
  return (
    <section className="spa-video-hero relative isolate h-[95svh] min-h-[620px] overflow-hidden rounded-b-[28px] bg-[#005268] text-white lg:rounded-b-[36px]">
      {heroVideos.length > 0 ? (
        ...
        <div className="absolute inset-0 -z-20 bg-[#005e73]" />
      )}
      <div className="absolute inset-0 -z-10 bg-[linear-gradient(90deg,rgba(0, 52, 67,0.58),rgba(0, 70, 87,0.22)_43%,rgba(0, 55, 69,0.34)),linear-gradient(0deg,rgba(0, 28, 36,0.18),rgba(0, 28, 36,0.08))]" />
