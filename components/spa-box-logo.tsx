...
const LOGO_URL =
  "https://res.cloudinary.com/dzykdnbvb/raw/upload/v1783470233/stage4/spa_leemhairspa/logo.svg";
...
export function SpaBoxLogo({ className = "", compact = false, tone = "light" }: SpaBoxLogoProps) {
  ...
  if (REAL_LOGO) {
    ...
    return (
      <span className={["relative inline-block", sizeClass, className].join(" ")} aria-label="Leem Hair Spa - Healthy hair, happy nails">
        <Image
          src={src}
          alt="Leem Hair Spa - Healthy hair, happy nails"
          fill
