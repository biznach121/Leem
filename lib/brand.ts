...
export const brand: Brand = {
  name: "Leem Hair Spa",
  shortName: "Leem",
  microTag: "HEALTHY HAIR, HAPPY NAILS",
  description:
    "Leem Hair Spa is a Accra beauty studio where treatments, care and calm come together under one roof.",
  ...
  contact: {
    ...
    countryCode: "GH",
    phone: "0532764967",
    phoneTel: "+233532764967",
    textPhone: "0532764967",
    textPhoneTel: "+233532764967",
    email: "hello@leem.test",
    privacyEmail: "privacy@leem.test",
    hours: "Call or text to book",
  },

  socials: [
    { label: "TikTok", href: "https://www.tiktok.com/@leem_hair_spa", icon: "tiktok" },
  ],
  ...
  editorial: {
    ...
    notes: [
      ...
      {
        body: "Leem Hair Spa exists so that slowing down doesn't cost you your rhythm. One hour here gives back more than it takes — a genuine reset with a visible result.",
    ...
    images: [
      {
        ...
        alt: "Leem Hair Spa beauty treatment detail",
      ...
      },
      {
        ...
        alt: "Leem Hair Spa self-care treatment",
        className: "right-[5%] top-[15%] h-[255px] w-[155px] rounded-[999px]",
        sizes: "155px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Leem Hair Spa beauty ritual",
      ...
      },
      {
        ...
        alt: "Leem Hair Spa calm care moment",
        className: "right-[6%] top-[68%] h-[145px] w-[100px] rounded-[999px]",
        sizes: "100px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/yqkj1i8lrp7m9zmlze4z.jpg",
        alt: "Leem Hair Spa relaxation detail",
        className: "left-[25%] top-[75%] h-[150px] w-[102px] rounded-[999px]",
        sizes: "102px",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/image/upload/v1780682215/bgkgjrchbkhtckgh9f7t.jpg",
        alt: "Leem Hair Spa beauty and peace detail",
    ...
    items: [
      {
        ...
        imageAlt: "Leem Hair Spa lip gloss product",
        tone: "light",
      },
      {
        name: "mint\nbeauty oil",
        ...
        imageAlt: "Leem Hair Spa mint oil product",
        tone: "olive",
      },
      {
        name: "brush\nessentials",
        ...
        imageAlt: "Leem Hair Spa makeup brush set",
        tone: "light",
      },
      {
        name: "smooth\nfoundation",
        ...
        imageAlt: "Leem Hair Spa foundation product",
        tone: "olive",
      },
    ],
  },
  ...
  media: {
    title: "media",
    ctaLabel: "Follow",
    ctaHref: "https://www.tiktok.com/@leem_hair_spa",
    images: [
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783470241/stage4/spa_leemhairspa/tiktok_0.mp4",
        alt: "Leem Hair Spa treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783470247/stage4/spa_leemhairspa/tiktok_1.mp4",
        alt: "Leem Hair Spa treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dzykdnbvb/video/upload/v1783470252/stage4/spa_leemhairspa/tiktok_2.mp4",
        alt: "Leem Hair Spa treatment video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581430/gse4jxivlcejlrtq3fjk.mp4",
        alt: "Leem Hair Spa self-care media video",
        position: "center",
      },
      {
        src: "https://res.cloudinary.com/dcc5ggnkc/video/upload/v1780581409/pq6ritvfxvxkhsjqkct4.mp4",
        alt: "Leem Hair Spa studio media video",
        position: "center",
      },
    ],
  },
  ...
  about: {
    eyebrow: "About Leem Hair Spa",
    title: "Your sanctuary\nof beauty and peace.",
    paragraphs: [
      "Leem Hair Spa is a curated beauty and self-care space in Accra, created for the moments when you want to feel polished, calm, and cared for without rushing through the process.",
    ...
    sections: [
      ...
      {
        heading: "Visit",
        body: "Find us in Accra. Use the Location page for the exact Google Maps pin, or call 0532764967 and text 0532764967 for booking help.",
      },
    ],
  },
    ...
    sections: [
      {
        ...
        items: [
          { q: "How do I book?", a: "Use the Book page, call 0532764967, text 0532764967, or message @leem_hair_spa on Instagram." },
          ...
          { q: "Where are you located?", a: "Leem Hair Spa is in Accra. The Location page has the exact Google Maps pin." },
        ],
      },
      {
        title: "Treatments",
  ...
  terms: {
    ...
    sections: [
      { heading: "1. Who we are", body: "Leem Hair Spa (\"we\", \"us\") is a beauty and self-care business in Accra, Ghana. By booking a service or buying a product, you agree to these terms." },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Your rights", body: "Under the Ghana Data Protection Act, 2012 (Act 843), you can access, correct, or delete your data. Email privacy@leem.test." },
  ...
  shipping: {
    ...
    sections: [
      ...
      { heading: "Location", body: "Leem Hair Spa is in Accra. Visit the Location page for the exact Google Maps pin." },
  ...
  accessibility: {
    ...
    sections: [
      ...
      { heading: "Reporting issues", body: "Email accessibility@leem.test, call, or text the studio. We respond within a business day." },
    ],
  },

  account: {
    loginEyebrow: "Welcome back",
    loginTitle: "Sign in to Leem Hair Spa",
  ...
  contactPage: {
    ...
    directLines: [
      { label: "Call", value: "0532764967", href: "tel:+233532764967" },
      { label: "Text", value: "0532764967", href: "sms:+233532764967" },
      { label: "Instagram", value: "@leem_hair_spa", href: "https://www.tiktok.com/@leem_hair_spa" },
    ],
  },
  ...
  footer: {
    blurb:
      "Leem Hair Spa in Accra — healthy hair, happy nails.",
    sitemap: [
      {
        title: "Visit",
        links: [
          ...
          { label: "Location", href: "/location" },
          { label: "Instagram", href: "https://www.tiktok.com/@leem_hair_spa" },
        ],
      },
      {
        title: "Studio",
      ...
      },
      {
        ...
        links: [
          ...
          { label: "Call 0532764967", href: "tel:+233532764967" },
          { label: "Text 0532764967", href: "sms:+233532764967" },
        ],
      },
      {
        title: "Account",
  ...
  llms: {
    summary:
      "Leem Hair Spa — beauty and self-care in Accra. Lashes, brows, nails, pedicure, waxing, piercing, facials, massage, and beauty products. Booking via website, call, text, or Instagram.",
  },
